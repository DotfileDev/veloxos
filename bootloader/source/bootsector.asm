...
.extension_functions_not_available:
        mov     si,     EXTENSIONS_NOT_AVAILABLE_MSG
        call    print_16bit
        jmp     $
...
EXTENSIONS_NOT_AVAILABLE_MSG    db      "Your BIOS doesn't support extension functions.", NULL
LOAD_KERNEL_LOADER_FAIL_MSG     db      "Failed to load kernel loader.", NULL

KERNEL_LOADER_SIZE              equ     (load_kernel_end - load_kernel) / 512
